...
struct Arrow_Flight_Protocol_Sql_CommandGetDbSchemas {
    ...
    var hasDbSchemaFilterPattern: Bool { return _dbSchemaFilterPattern != nil }
...
struct Arrow_Flight_Protocol_Sql_CommandGetTables {
    ...
    var hasTableNameFilterPattern: Bool { return _tableNameFilterPattern != nil }
    /// Clears the value of `tableNameFilterPattern`. Subsequent reads from it will return its default value.
    mutating func clearTableNameFilterPattern() { _tableNameFilterPattern = nil }
...
struct Arrow_Flight_Protocol_Sql_CommandGetCrossReference {
    ...
    var hasPkCatalog: Bool { return _pkCatalog != nil }
    /// Clears the value of `pkCatalog`. Subsequent reads from it will return its default value.
    mutating func clearPkCatalog() { _pkCatalog = nil }
    ...
    var hasPkDbSchema: Bool { return _pkDbSchema != nil }
    /// Clears the value of `pkDbSchema`. Subsequent reads from it will return its default value.
    mutating func clearPkDbSchema() { _pkDbSchema = nil }

    /// *
    /// The parent table name. It cannot be null.
    var pkTable: String = .init()
    ...
    var hasFkCatalog: Bool { return _fkCatalog != nil }
    /// Clears the value of `fkCatalog`. Subsequent reads from it will return its default value.
    mutating func clearFkCatalog() { _fkCatalog = nil }
    ...
    var hasFkDbSchema: Bool { return _fkDbSchema != nil }
    /// Clears the value of `fkDbSchema`. Subsequent reads from it will return its default value.
    mutating func clearFkDbSchema() { _fkDbSchema = nil }

    /// *
    /// The foreign table name. It cannot be null.
    var fkTable: String = .init()
    ...
    fileprivate var _fkDbSchema: String?
}
...
struct Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementRequest {
    ...
    var hasTransactionID: Bool { return _transactionID != nil }
...
struct Arrow_Flight_Protocol_Sql_ActionCreatePreparedSubstraitPlanRequest {
    ...
    var hasPlan: Bool { return _plan != nil }
    /// Clears the value of `plan`. Subsequent reads from it will return its default value.
    mutating func clearPlan() { _plan = nil }
...
private let _protobuf_package = "arrow.flight.protocol.sql"
...
extension Arrow_Flight_Protocol_Sql_CommandGetSqlInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeRepeatedUInt32Field(value: &info)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !info.isEmpty {
            try visitor.visitPackedUInt32Field(value: info, fieldNumber: 1)
        }
...
extension Arrow_Flight_Protocol_Sql_CommandGetXdbcTypeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularInt32Field(value: &_dataType)
            default: break
            }
        }
    }
...
extension Arrow_Flight_Protocol_Sql_CommandGetDbSchemas: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &_catalog)
            case 2: try decoder.decodeSingularStringField(value: &_dbSchemaFilterPattern)
            default: break
            }
        }
    }
...
extension Arrow_Flight_Protocol_Sql_CommandGetTables: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try decoder.decodeSingularStringField(value: &_catalog)
            case 2: try decoder.decodeSingularStringField(value: &_dbSchemaFilterPattern)
            case 3: try decoder.decodeSingularStringField(value: &_tableNameFilterPattern)
            case 4: try decoder.decodeRepeatedStringField(value: &tableTypes)
            case 5: try decoder.decodeSingularBoolField(value: &includeSchema)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !tableTypes.isEmpty {
            try visitor.visitRepeatedStringField(value: tableTypes, fieldNumber: 4)
        }
        if includeSchema != false {
            try visitor.visitSingularBoolField(value: includeSchema, fieldNumber: 5)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_CommandGetPrimaryKeys: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &_catalog)
            case 2: try decoder.decodeSingularStringField(value: &_dbSchema)
            case 3: try decoder.decodeSingularStringField(value: &table)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !table.isEmpty {
            try visitor.visitSingularStringField(value: table, fieldNumber: 3)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_CommandGetCrossReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &_pkCatalog)
            case 2: try decoder.decodeSingularStringField(value: &_pkDbSchema)
            case 3: try decoder.decodeSingularStringField(value: &pkTable)
            case 4: try decoder.decodeSingularStringField(value: &_fkCatalog)
            case 5: try decoder.decodeSingularStringField(value: &_fkDbSchema)
            case 6: try decoder.decodeSingularStringField(value: &fkTable)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !pkTable.isEmpty {
            try visitor.visitSingularStringField(value: pkTable, fieldNumber: 3)
        }
        ...
        if !fkTable.isEmpty {
            try visitor.visitSingularStringField(value: fkTable, fieldNumber: 6)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try decoder.decodeSingularBytesField(value: &_transactionID)
            default: break
            }
        }
    }
...
extension Arrow_Flight_Protocol_Sql_SubstraitPlan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &plan)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !plan.isEmpty {
            try visitor.visitSingularBytesField(value: plan, fieldNumber: 1)
        }
        if !version.isEmpty {
...
extension Arrow_Flight_Protocol_Sql_ActionCreatePreparedSubstraitPlanRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_plan)
            case 2: try decoder.decodeSingularBytesField(value: &_transactionID)
            default: break
            }
        }
...
extension Arrow_Flight_Protocol_Sql_ActionCreatePreparedStatementResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &preparedStatementHandle)
            case 2: try decoder.decodeSingularBytesField(value: &datasetSchema)
            case 3: try decoder.decodeSingularBytesField(value: &parameterSchema)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !preparedStatementHandle.isEmpty {
            try visitor.visitSingularBytesField(value: preparedStatementHandle, fieldNumber: 1)
        }
        if !datasetSchema.isEmpty {
            try visitor.visitSingularBytesField(value: datasetSchema, fieldNumber: 2)
        }
        if !parameterSchema.isEmpty {
            try visitor.visitSingularBytesField(value: parameterSchema, fieldNumber: 3)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_ActionBeginSavepointRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &transactionID)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !transactionID.isEmpty {
            try visitor.visitSingularBytesField(value: transactionID, fieldNumber: 1)
        }
        if !name.isEmpty {
...
extension Arrow_Flight_Protocol_Sql_ActionBeginSavepointResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &savepointID)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !savepointID.isEmpty {
            try visitor.visitSingularBytesField(value: savepointID, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_ActionEndTransactionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &transactionID)
            case 2: try decoder.decodeSingularEnumField(value: &action)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if action != .unspecified {
            try visitor.visitSingularEnumField(value: action, fieldNumber: 2)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_TicketStatementQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &statementHandle)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !statementHandle.isEmpty {
            try visitor.visitSingularBytesField(value: statementHandle, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_DoPutUpdateResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularInt64Field(value: &recordCount)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if recordCount != 0 {
            try visitor.visitSingularInt64Field(value: recordCount, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Arrow_Flight_Protocol_Sql_ActionCancelQueryRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &info)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !info.isEmpty {
            try visitor.visitSingularBytesField(value: info, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
