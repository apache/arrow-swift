...
protocol Arrow_Flight_Protocol_FlightServiceClientProtocol: GRPCClient {
...
extension Arrow_Flight_Protocol_FlightServiceClientProtocol {
    ...
    func handshake(
        ...
        return makeBidirectionalStreamingCall(
            ...
            interceptors: interceptors?.makeHandshakeInterceptors() ?? [],
            handler: handler
        )
    }
    ...
    func listFlights(
        ...
        return makeServerStreamingCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeListFlightsInterceptors() ?? [],
            handler: handler
        )
    }
    ...
    func getFlightInfo(
        ...
        return makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeGetFlightInfoInterceptors() ?? []
        )
    }
    ...
    func getSchema(
        ...
        return makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeGetSchemaInterceptors() ?? []
        )
    }
    ...
    func doGet(
        ...
        return makeServerStreamingCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeDoGetInterceptors() ?? [],
            handler: handler
        )
    }
    ...
    func doPut(
        ...
        return makeBidirectionalStreamingCall(
            ...
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeDoPutInterceptors() ?? [],
            handler: handler
        )
    }
    ...
    func doExchange(
        ...
        return makeBidirectionalStreamingCall(
            ...
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeDoExchangeInterceptors() ?? [],
            handler: handler
        )
    }
    ...
    func doAction(
        ...
        return makeServerStreamingCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeDoActionInterceptors() ?? [],
            handler: handler
        )
    }
    ...
    func listActions(
        ...
        return makeServerStreamingCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeListActionsInterceptors() ?? [],
            handler: handler
        )
    }
}
...
final class Arrow_Flight_Protocol_FlightServiceClient: Arrow_Flight_Protocol_FlightServiceClientProtocol {
    ...
    var interceptors: Arrow_Flight_Protocol_FlightServiceClientInterceptorFactoryProtocol? {
...
struct Arrow_Flight_Protocol_FlightServiceNIOClient: Arrow_Flight_Protocol_FlightServiceClientProtocol {
...
protocol Arrow_Flight_Protocol_FlightServiceAsyncClientProtocol: GRPCClient {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
struct Arrow_Flight_Protocol_FlightServiceAsyncClient: Arrow_Flight_Protocol_FlightServiceAsyncClientProtocol {
    var channel: GRPCChannel
    var defaultCallOptions: CallOptions
    var interceptors: Arrow_Flight_Protocol_FlightServiceClientInterceptorFactoryProtocol?
...
protocol Arrow_Flight_Protocol_FlightServiceClientInterceptorFactoryProtocol: Sendable {
...
enum Arrow_Flight_Protocol_FlightServiceClientMetadata {
    ...
    enum Methods {
        static let handshake = GRPCMethodDescriptor(
            name: "Handshake",
            path: "/arrow.flight.protocol.FlightService/Handshake",
            type: GRPCCallType.bidirectionalStreaming
        )

        static let listFlights = GRPCMethodDescriptor(
            name: "ListFlights",
        ...
        static let doGet = GRPCMethodDescriptor(
            name: "DoGet",
        ...
        static let doExchange = GRPCMethodDescriptor(
            name: "DoExchange",
            path: "/arrow.flight.protocol.FlightService/DoExchange",
            type: GRPCCallType.bidirectionalStreaming
        )

        static let doAction = GRPCMethodDescriptor(
            name: "DoAction",
            path: "/arrow.flight.protocol.FlightService/DoAction",
            type: GRPCCallType.serverStreaming
        )

        static let listActions = GRPCMethodDescriptor(
            name: "ListActions",
...
protocol Arrow_Flight_Protocol_FlightServiceProvider: CallHandlerProvider {
    ...
    func handle(
        ...
        case "Handshake":
            return BidirectionalStreamingServerHandler(
                ...
                interceptors: interceptors?.makeHandshakeInterceptors() ?? [],
                observerFactory: handshake(context:)
            )
        ...
        case "ListFlights":
            return ServerStreamingServerHandler(
                ...
                interceptors: interceptors?.makeListFlightsInterceptors() ?? [],
                userFunction: listFlights(request:context:)
            )
        ...
        case "GetFlightInfo":
            return UnaryServerHandler(
                ...
                responseSerializer: ProtobufSerializer<Arrow_Flight_Protocol_FlightInfo>(),
                interceptors: interceptors?.makeGetFlightInfoInterceptors() ?? [],
                userFunction: getFlightInfo(request:context:)
            )
        ...
        case "GetSchema":
            return UnaryServerHandler(
                ...
                interceptors: interceptors?.makeGetSchemaInterceptors() ?? [],
                userFunction: getSchema(request:context:)
            )
        ...
        case "DoGet":
            return ServerStreamingServerHandler(
                ...
                interceptors: interceptors?.makeDoGetInterceptors() ?? [],
                userFunction: doGet(request:context:)
            )
        ...
        case "DoExchange":
            return BidirectionalStreamingServerHandler(
                ...
                responseSerializer: ProtobufSerializer<Arrow_Flight_Protocol_FlightData>(),
                interceptors: interceptors?.makeDoExchangeInterceptors() ?? [],
                observerFactory: doExchange(context:)
            )
        ...
        case "DoAction":
            return ServerStreamingServerHandler(
                ...
                interceptors: interceptors?.makeDoActionInterceptors() ?? [],
                userFunction: doAction(request:context:)
            )
        ...
        case "ListActions":
            return ServerStreamingServerHandler(
                ...
                interceptors: interceptors?.makeListActionsInterceptors() ?? [],
                userFunction: listActions(request:context:)
            )
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
protocol Arrow_Flight_Protocol_FlightServiceAsyncProvider: CallHandlerProvider, Sendable {
    static var serviceDescriptor: GRPCServiceDescriptor { get }
    var interceptors: Arrow_Flight_Protocol_FlightServiceServerInterceptorFactoryProtocol? { get }
...
protocol Arrow_Flight_Protocol_FlightServiceServerInterceptorFactoryProtocol: Sendable {
...
enum Arrow_Flight_Protocol_FlightServiceServerMetadata {
    static let serviceDescriptor = GRPCServiceDescriptor(
        name: "FlightService",
        fullName: "arrow.flight.protocol.FlightService",
        methods: [
