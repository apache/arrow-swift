...
final class InternalFlightServer: Arrow_Flight_Protocol_FlightServiceAsyncProvider {
    ...
    func handshake(requestStream _: GRPC.GRPCAsyncRequestStream<Arrow_Flight_Protocol_HandshakeRequest>,
                   responseStream _: GRPC.GRPCAsyncResponseStreamWriter<Arrow_Flight_Protocol_HandshakeResponse>,
                   context _: GRPC.GRPCAsyncServerCallContext) async throws {
    ...
    func getFlightInfo(request: Arrow_Flight_Protocol_FlightDescriptor,
                       context _: GRPC.GRPCAsyncServerCallContext) async throws -> Arrow_Flight_Protocol_FlightInfo {
        if let server = arrowFlightServer {
    ...
    func getSchema(request: Arrow_Flight_Protocol_FlightDescriptor,
                   context _: GRPC.GRPCAsyncServerCallContext) async throws -> Arrow_Flight_Protocol_SchemaResult {
        if let server = arrowFlightServer {
    ...
    func listActions(request _: Arrow_Flight_Protocol_Empty,
    ...
    var interceptors: Arrow_Flight_Protocol_FlightServiceServerInterceptorFactoryProtocol? { return nil }
}
